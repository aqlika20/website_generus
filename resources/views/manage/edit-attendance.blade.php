										...
										<div class="card">
											<div class="card-body text-center bg-white-100 radius shadow-2xl">
												...
												<div class="text-left">
													...
													<form action="{{ route('attendance.edit.store',[$subject->id]) }}" method="post">
														@csrf
														@method('PUT')
																...
																@foreach ($generuses as $generus)
																	<tr>
																		...
																		<td class="text-capitalize">
																			<input type="text" name="students[]" value="{{ $generus->id }}"
																				hidden>
																		...
																		<td class="">
																			<div class="custom-control custom-radio d-inline mr-2">
																				<input type="radio" id="radio-{{ $generus->id }}-on"
																					...
																					class="custom-control-input" {{ $generus->status == 1 ? 'checked' : '' }}>
																			...
																			<div class="custom-control custom-radio d-inline">
																				<input type="radio" id="radio-{{ $generus->id }}-off"
																					...
																					class="custom-control-input" {{ $generus->status == 0 ? 'checked' : '' }}>
																				<label class="custom-control-label"
