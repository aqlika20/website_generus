...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Generusbatuaji | Absensi</title>
							...
							<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
								<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
									...
									<div class="d-flex align-items-center flex-wrap mr-2">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Absensi</h5>
									...
									<div class="col-md-12">
										<div class="card">
											<div class="card-body text-center bg-white-100 radius shadow-2xl">
												<h2 class="mt-4">Absensi : {{ $subject->name }}</h2>
												<h3>Tanggal : {{ Carbon\Carbon::parse($attendance->date)->format('d M, Y') }}</h3>
												<h4> Jumlah Generus : {{ $generusCount }} Orang </h4>
												<hr>
												<div class="text-left">
													...
													<div class="table-responsive">
														<input type="text" name="id" value="{{ $attendance->id }}" hidden>
														<table class="table align-items-center table-flush">
															<thead class="thead-light">
															<tr>
																<th scope="col" class="sort" data-sort="name">Nama</th>
																<th scope="col" class="sort" data-sort="action">Yang Hadir</th>
															</tr>
															</thead>
															<tbody class="list">
