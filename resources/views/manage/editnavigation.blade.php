...
<html lang="en">
	...
	<head><base href="">
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="media/logos" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="{{ route('home')}}">
				<img alt="Logo" src="media/logos/SATREPS.svg" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Navigation</h5>
								...
								<div class="card card-custom gutter-b">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Edit Navigation 
										</div>
									</div>
									<div class="card-body">
										<!--begin: Search Form-->
                                        ...
                                        <!--end::Header-->
                                        <!--begin::Body-->
										<form method="POST" action="{{ route('navigation.edit',[$navigation->id]) }}" enctype="multipart/form-data">
											@csrf
											@method('PATCH')
											<div class="card-body">
												<div class="form-group">
													<label>Name</label>
													<input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $navigation->name }}" required autocomplete="name" autofocus>
												</div>
												<div class="form-group">
													<label>Insert icon class here</label>
													<input id="icon" type="text" class="form-control @error('icon') is-invalid @enderror" name="icon" value="{{ $navigation->icon }}" required autocomplete="icon" autofocus>
												</div>
												<div class="form-group">
												<a class="btn btn-info mr-2" href="{{ route('icon') }}" target="_blank"><ins>Icon List</ins></a>
													<!-- <a href="https://boxicons.com" target="_blank"  class="btn btn-info mr-2">Icon List</a> -->
												</div>
												<div class="form-group row">
													...
													<div class="col-9 col-form-label">
														<select class="form-control custom-select" name="self_url" id="self_url">
															...
															<option value="1" {{ $navigation->self_url == 1 ? 'selected' : '' }} >True</option>
															<option value="2" {{ $navigation->self_url == 2 ? 'selected' : '' }} >False</option>
														</select>
													</div>
												</div>
														...
														<div class="col-9 col-form-label">
															<select class="form-control custom-select" id="content_id" name="content_id">
																...
																@foreach ($contents as $content)
																	<option value="{{$content->id}}" {{ old('content_id', $content->id) == $content->id ? 'selected' : '' }}>ID : {{$content->id}} | Name : {{$content->name}}</option>
																@endforeach
															</select>
														</div>
													</div>
												...
												<div  id="otherFieldDiv_2">
													<div class="form-group">
														<label>Url</label>
														<input id="url" name="url" value="{{ $navigation->url }}" type="text" class="form-control @error('url') is-invalid @enderror" autocomplete="name" autofocus/>
													</div>
												</div>
											</div>
											<div class="card-footer">
												<button type="submit" class="btn btn-primary mr-2">Submit</button>
												<a href="{{ route('navigation')}}" class="btn btn-danger mr-2">Cancel</a>
											</div>
										</form>
										<!--end: Datatable-->
									</div>
		...
		<script src="js/pages/crud/ktdatatable/base/html-table.js"></script>
	...
	<script>
		...
		$("#self_url").change(function() {
			triggerFieldDiv($(this).val())
		});

		function triggerFieldDiv(value){
			if (value == "2") {
		...
		triggerFieldDiv('{{$navigation->self_url}}')
	</script>
</html>