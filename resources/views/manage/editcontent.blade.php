...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="plugins/custom/fullcalendar/fullcalendar.bundle" rel="stylesheet" type="text/css" />
		<!--end::Page Vendors Styles-->
		<!--begin::Global Theme Styles(used by all pages)-->
		<link href="plugins/global/plugins.bundle" rel="stylesheet" type="text/css" />
		<link href="plugins/custom/prismjs/prismjs.bundle" rel="stylesheet" type="text/css" />
		<link href="css/style.bundle" rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<link href="css/themes/layout/header/base/light" rel="stylesheet" type="text/css" />
		<link href="css/themes/layout/header/menu/light" rel="stylesheet" type="text/css" />
		<link href="css/themes/layout/brand/dark" rel="stylesheet" type="text/css" />
		<link href="css/themes/layout/aside/dark" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
											   ...
											   <form method="POST" action="{{ route('content.edit',[$content->id]) }}" enctype="multipart/form-data">
												   ...
												   <div class="card-body">
														...
														<div class="form-group">
															<label>Image</label>
															<br>
															<img src="storage/Content/'.$content->image) }}" class="img-fluid mb-3" width="500" height="333" alt="">
