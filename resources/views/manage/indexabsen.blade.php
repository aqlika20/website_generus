																...
																@foreach ($attendances as $attendance)
																	<tr>
																		...
																		<td>
																			...
																			@csrf 
																			@method('DELETE')
																				<a class="btn btn-icon btn-light btn-sm mx-1" href="{{ route('attendance.edit',[$attendance->id]) }}"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
