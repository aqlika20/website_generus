						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Kegiatan Pengajian</h5>
								...
								<div class="card card-custom gutter-b">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Edit Kegiatan Pengajian 
										</div>
									</div>
									<div class="card-body">
										<form method="POST" action="{{ route('kegiatan.edit',[$kegiatan->id]) }}" enctype="multipart/form-data">
											@csrf
											@method('PATCH')
											<div class="card-body">
												<div class="form-group">
													<label>Nama Kegiatan</label>
													<input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $kegiatan->name }}" required autocomplete="name" autofocus>
												</div>
												<div class="form-group">
													<label for="exampleTextarea">Description</label>
													<textarea type="text" class="form-control form-control-solid" placeholder="Enter Your Address" id="description" name="description" rows="3" required autocomplete="description" autofocus>{{old('description', $kegiatan->description)}}</textarea>
												</div>
											</div>
											<div class="card-footer">
												<button type="submit" class="btn btn-primary mr-2">Submit</button>
												<a href="{{ route('kegiatan')}}" class="btn btn-danger mr-2">Cancel</a>
											</div>
										</form>
									</div>
								</div>
