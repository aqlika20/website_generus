									...
									<div class="card card-custom gutter-b">
										<div class="card-header flex-wrap border-0 pt-6 pb-0">
											<div class="card-title">
												<h3 class="card-label">Daftar Kegiatan Pengajian
											</div>
											<div class="card-toolbar">
												...
												<span class="svg-icon svg-icon-md">
													...
													<!--end::Svg Icon-->
												</span>Tambah Kegiatan Pengajian</a>
												<!--end::Button-->
											</div>
										</div>
																...
																<tbody>
																	...
																	@foreach($kegiatans as $kegiatan)
																		<tr>
																			...
																			<td>
																				<form method="POST" action="{{ route('kegiatan.delete',[$kegiatan->id]) }}">
																				@csrf 
																				@method('DELETE')
																					<a class="btn btn-icon btn-light btn-sm mx-1" href="{{ route('kegiatan.view',[$kegiatan->id]) }}"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
