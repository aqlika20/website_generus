						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Dalil - Dalil</h5>
								...
								<div class="card card-custom gutter-b">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Edit Dalil - Dalil 
										</div>
									</div>
									<div class="card-body">
										<form method="POST" action="{{ route('dalil.edit',[$dalil->id]) }}" enctype="multipart/form-data">
											@csrf
											@method('PATCH')
											<div class="card-body">
												<div class="form-group">
													<label>Title</label>
													<input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $dalil->title }}" required autocomplete="title" autofocus>
												</div>
												<div class="form-group">
													<label>Image</label>
													<br>
													<img src="{{ asset('storage/Dalil-Dalil/'.$dalil->image) }}" class="img-fluid mb-3" width="500" height="333" alt="">
												...
												<div class="form-group">
													<label for="exampleTextarea">Latin</label>
													<textarea type="text" class="form-control form-control-solid" placeholder="Enter Your Address" id="latin" name="latin" rows="3" required autocomplete="latin" autofocus>{{old('latin', $dalil->latin)}}</textarea>
												</div>
												<div class="form-group">
													<label for="exampleTextarea">Artinya</label>
													<textarea type="text" class="form-control form-control-solid" placeholder="Enter Your Address" id="arti" name="arti" rows="3" required autocomplete="arti" autofocus>{{old('arti', $dalil->arti)}}</textarea>
												</div>
											</div>
											
											<input d="last_img" name="last_img" type="hidden" value="{{ $dalil->image }}">
											<div class="card-footer">
												<button type="submit" class="btn btn-primary mr-2">Submit</button>
												<a href="{{ route('dalil')}}" class="btn btn-danger mr-2">Cancel</a>
											</div>
										</form>
									</div>
								</div>
