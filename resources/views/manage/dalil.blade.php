									...
									<div class="card card-custom gutter-b">
										<div class="card-header flex-wrap border-0 pt-6 pb-0">
											<div class="card-title">
												<h3 class="card-label">Daftar Dalil
											</div>
										...
										<div class="modal fade" id="exampleModalCenter" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
											<div class="modal-dialog center-modal modal-xl" role="document">
												<div class="modal-content">
													<div class="card card-custom gutter-b">
														...
														<form method="POST" action="{{ route('dalil.store') }}" enctype="multipart/form-data">
															@csrf
															@method('PATCH')
															<div class="card-body">
																...
																<div class="form-group">
																	<label>Gambar Dalil-Dalil</label>
																...
																<div class="form-group">
																	<label>Latin</label>
																	<textarea id="latin" type="text" class="form-control" name="latin" value="{{old('latin')}}" required autocomplete="latin" autofocus></textarea>
																</div>
																<div class="form-group">
																	<label>Arti</label>
																	<textarea id="arti" type="text" class="form-control" name="arti" value="{{old('arti')}}" required autocomplete="arti" autofocus></textarea>
																</div>
															</div>
																...
																<tbody>
																	...
																	@foreach($dalils as $dalil)
																		<tr>
																			...
																			<td>
																				<form method="POST" action="{{ route('dalil.delete',[$dalil->id]) }}">
																				@csrf 
																				@method('DELETE')
																					<a class="btn btn-icon btn-light btn-sm mx-1" href="{{ route('dalil.view',[$dalil->id]) }}"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
