...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Generusbatuaji | Do'a - Do'a</title>
											...
											<div class="modal-dialog center-modal modal-xl" role="document">
												<div class="modal-content">
													<div class="card card-custom gutter-b">
														...
														<form method="POST" action="{{ route('doa.store') }}" enctype="multipart/form-data">
															@csrf
															@method('PATCH')
															<div class="card-body">
																	...
																	@foreach($doas as $doa)
																		<tr>
																			...
																			<td>
																				...
																				@csrf 
																				@method('DELETE')
																					<a class="btn btn-icon btn-light btn-sm mx-1" href="{{ route('doa.view',[$doa->id]) }}"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
